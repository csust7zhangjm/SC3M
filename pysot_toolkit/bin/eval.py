...
from pysot_toolkit.pysot.datasets import OTBDataset, UAVDataset, LaSOTDataset, VOTDataset, NFSDataset, VOTLTDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, help='dataset root directory',default = '/mnt/data/test_data/VOT2018')
    parser.add_argument('--dataset', type=str, help='dataset name' ,default='VOT2018')
    parser.add_argument('--tracker_result_dir', type=str, help='tracker result root', default='/home/hyf/SiamGAT/tools/results')
    parser.add_argument('--trackers', nargs='+',default='checkpoint_double_pgcorr_e14')
