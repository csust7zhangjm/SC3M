...
parser.add_argument('--lr', default='0.4,1,1', type=parse_range)
parser.add_argument('--window-influence', default='0.44,1,1', type=parse_range)
parser.add_argument('--penalty-k', default='0.03,0.05,0.0005', type=parse_range)
