...
parser.add_argument('--snapshot', default='pth_fused_dpw/fused_pgcorr_got_e20.pth', type=str, help='snapshot of model')
parser.add_argument('--dataset', default='VOT2018', type=str, help='dataset name to eval')

parser.add_argument('--lr', default='0.30,0.42,0.02', type=parse_range)
parser.add_argument('--window-influence', default='0.3,0.5,0.05', type=parse_range)
parser.add_argument('--penalty-k', default='0.10,0.22,0.02', type=parse_range)
...
parser.add_argument('--search-region', default='287,288,8', type=parse_range_int)
parser.add_argument('--config', default='../experiments/siamgat_googlenet/config.yaml', type=str)
...
if __name__ == '__main__':
    ...
    dataset_root = os.path.realpath('/mnt/data/test_data/' + args.dataset)
