...
from toolkit.evaluation import AccuracyRobustnessBenchmark, EAOBenchmark
...
parser.add_argument('--tracker_path', '-p', type=str, default='results',  # results hp_search_result
...
def main():
    ...
    root = os.path.realpath('/mnt/data/test_data/' + args.dataset)
