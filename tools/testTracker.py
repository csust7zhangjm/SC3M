...
parser.add_argument('--dataset', type=str, default='UAV123',
        help='datasets') # OTB100  UAV123 GOT-10k VOT2016 VOT2018
parser.add_argument('--vis', action='store_true', default=True,
        help='whether visualzie result')
parser.add_argument('--snapshot', type=str, default='pth_fused_dpw/fused_pgcorr_got_e20.pth',
...
def main():
    ...
    dataset_root = os.path.join('/mnt/data/test_data', args.dataset)
