...
#TODO : 对于train GOT-10k的数据需不需要导入  pysot.models.model_builder_gat_got
...
parser.add_argument('--cfg', type=str, default='../experiments/siamgat_googlenet_got10k/config.yaml',
        ...
        if epoch != idx // num_per_epoch + start_epoch:
            ...
            if get_rank() == 0:
                torch.save(
                        ...
                        cfg.TRAIN.SNAPSHOT_DIR+'/fused_pw_got2_e%d.pth' % (epoch))
    ...
    if rank == 0:
        ...
        if cfg.TRAIN.LOG_DIR:
            add_file_handler('global',
                             os.path.join(cfg.TRAIN.LOG_DIR, 'logsPw.txt'),
                             logging.INFO)
